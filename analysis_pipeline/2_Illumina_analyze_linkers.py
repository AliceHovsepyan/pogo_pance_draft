...
data_dir = "data/Illumina/R36" # Base directory containing /references and /blast/alignments subfolders
...
roi_startseq = "gccacaa".upper() 
roi_endseq = "tgctgaaaac".upper()
filter_for_reads_with_roi = True  # Only include reads that span the full ROI (region of interest)
